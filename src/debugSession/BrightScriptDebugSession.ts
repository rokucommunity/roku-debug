        ...
        try {
            ...
            try {
                ...
                if (this.deviceInfo.ecpSettingMode === 'limited') {
                    return await this.shutdown(`Please ensure 'Settings' > 'System' > 'Advanced system settings' > 'Control by mobile apps' is set to "Enabled" or "Permissive" on your Roku device for the debugger to communicate properly. Current mode: Limited (device: ${this.launchConfiguration.host})`);
                }
            } catch (e) {
                if (e instanceof EcpNetworkAccessModeDisabledError) {
                    return this.shutdown(`Please ensure 'Settings' > 'System' > 'Advanced system settings' > 'Control by mobile apps' is set to "Enabled" or "Permissive" on your Roku device for the debugger to communicate properly. Current mode: Disabled (device: ${this.launchConfiguration.host})`);
                }
