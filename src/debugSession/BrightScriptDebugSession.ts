...
import { rokuDeploy, CompileError, isUpdateCheckRequiredError, isConnectionResetError, ECPNetworkAccessDisabledError } from 'roku-deploy';
...
export class BrightScriptDebugSession extends BaseDebugSession {
    ...
    public async launchRequest(response: DebugProtocol.LaunchResponse, config: LaunchConfiguration) {
        ...
        try {
            ...
            if (e instanceof ECPNetworkAccessDisabledError) {
