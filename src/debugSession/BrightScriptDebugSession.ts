        ...
        try {
            ...
            try {
                ...
                if (e instanceof EcpNetworkAccessModeDisabledError) {
                    return this.shutdown(`Please ensure 'Settings' > 'System' > 'Advanced system settings' > 'Control by mobile apps' is set to "Enabled" or "Permissive" on your Roku device for the debugger to communicate properly. Current mode: off (device: ${this.launchConfiguration.host})`);
                }
